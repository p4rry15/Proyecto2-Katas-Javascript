//Dada una lista de álbumes de música, utiliza un bucle para sumar
// todas las duraciones solo de los álbumes de rock y luego imprime el
...
console.log(
  `La duración total de los álbumes de Rock es: ${totalRockDuration}`,
);
